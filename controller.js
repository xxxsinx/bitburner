...
const QmConfig = new Object({
	MaxPreppingServers: 40,		// how many servers can be in prep simultaneously
	MaxBatchingServers: 40,		// how many servers can be batching at the same time
	MaxServers: 80,				// how many servers can be active at all times (if this is smaller than the two previous values, they will alternate as needed)
	ListMaxServers: 40,			// how many servers are analyzed. More trivial servers are dropped from the list.
