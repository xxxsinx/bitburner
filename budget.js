...
export const RamBudget = (ns) => GenericBudget(ns, 'RAM', 'servers', ns.getPlayer().hasCorporation ? 0.7 : 0.4, ns.getPlayer().hasCorporation ? 0.75 : 0.2);
export const GangBudget = (ns) => GenericBudget(ns, 'Gang', 'gang', 0.25, 0.2);
