...
const QmConfig = new Object({
	MaxPreppingServers: 5,		// how many servers can be in prep simultaneously
	MaxBatchingServers: 2,		// how many servers can be batching at the same time
	MaxServers: 6,				// how many servers can be active at all times (if this is smaller than the two previous values, they will alternate as needed)
